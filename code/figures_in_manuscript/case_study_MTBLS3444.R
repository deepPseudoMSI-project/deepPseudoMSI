...
setwd("data_analysis/public_case_study/MTBLS3444/")
...
result4 <- readr::read_csv("vgg/predicted_224x224_fold4.csv")
result5 <- readr::read_csv("vgg/predicted_224x224_fold5.csv")

result1 <- result1[-nrow(result1), ]
result2 <- result2[-nrow(result2), ]
result3 <- result3[-nrow(result3), ]
result4 <- result4[-nrow(result4), ]
result5 <- result5[-nrow(result5), ]
...
ggsave(plot, filename = "result.pdf", width = 7, height = 7)
