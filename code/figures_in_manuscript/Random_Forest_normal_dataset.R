...
setwd("data_analysis/random_forest/normal_dataset/")
...
###
rmse <-
  cal_rmse(predicted_result$true, predicted_result$predicted) %>%
  round(2)
...
ggsave(
  plot,
  filename = "rmse_for_each_preson.pdf",
  width = 7,
  height = 7,
  bg = "transparent"
)
